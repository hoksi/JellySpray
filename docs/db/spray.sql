...
insert  into `spray_command`(`spray_command_id`,`group_name`,`command`,`stype`,`ptype`,`desc`,`created`) values (1,'comment','','group','guest','댓글 관련 전문','2014-01-09 14:52:29');
insert  into `spray_command`(`spray_command_id`,`group_name`,`command`,`stype`,`ptype`,`desc`,`created`) values (2,'feed','','group','guest','Feed 관련 전문','2014-01-09 14:52:33');
insert  into `spray_command`(`spray_command_id`,`group_name`,`command`,`stype`,`ptype`,`desc`,`created`) values (3,'member','','group','guest','회원 관련 전문','2014-01-09 14:52:36');
insert  into `spray_command`(`spray_command_id`,`group_name`,`command`,`stype`,`ptype`,`desc`,`created`) values (9,'toast1','','group','guest','테스트용 그룹명','2014-01-09 17:08:24');
insert  into `spray_command`(`spray_command_id`,`group_name`,`command`,`stype`,`ptype`,`desc`,`created`) values (10,'test','','group','guest','test','2014-01-09 17:14:35');
...
insert  into `spray_template`(`spray_template_id`,`name`,`type`,`content`) values (4,'default','controller_validation','		$ret = FALSE;\r\n\r\n		// validation 조건 확인\r\n		$config = array(\r\n			{validation}\r\n		);\r\n\r\n		if($this->form_chk($config)) {\r\n			$this->post_data = array(\r\n				{post_data}\r\n			);\r\n\r\n			$ret = TRUE;\r\n		} else {\r\n			$this->responseCode = -1;\r\n			\r\n			foreach($this->error_chk() as $err) {\r\n				{err_code}\r\n			}\r\n\r\n			$this->responseMessage = $err ? $err : \'데이터가 입력되지 않았습니다.\';\r\n		}\r\n');
